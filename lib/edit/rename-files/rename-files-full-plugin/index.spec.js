...
test('edit: rename-files-full: no report with options: equal: different length', (t) => {
...
test('edit: rename-files-full: transform with options', (t) => {
    const from = [
        '/hello/README.md',
    ];
...
test('edit: rename-files-full: transform with options: remove', (t) => {
    const from = [
        '/hello/README.md',
    ];
