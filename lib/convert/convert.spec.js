...
test('redlint: convert: toml to yaml', (t) => {
    const filesystem = stringify(['/hello/world/', [
        '/hello/world/bunfig.toml',
        '[install]\nlockfile = false\nlinker = "hoisted"\n',
    ]]);
    
    const converted = convert('bunfig.toml', CONVERT_TOML_TO_YAML, filesystem, {
        merge,
        branch,
    });
    ...
    const expected = ['/hello/world/', [
        '/hello/world/bunfig.yaml',
        'aW5zdGFsbDoKICBsb2NrZmlsZTogZmFsc2UKICBsaW5rZXI6IGhvaXN0ZWQK',
    ]];
...
test('redlint: convert: yaml to toml', (t) => {
    const filesystem = stringify(['/hello/world/', [
        '/hello/world/bunfig.yaml',
        'install:\n  lockfile: false\n  linker: hoisted\n',
    ]]);
    
    const converted = convert('bunfig.yaml', CONVERT_YAML_TO_TOML, filesystem, {
        merge,
        branch,
    });
